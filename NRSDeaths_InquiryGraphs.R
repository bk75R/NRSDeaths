...
DeathsTogetherCum2020_2021 <- rbind.data.frame(DeathsTogetherCum2020,DeathsTogetherCum2021)

# Add year, ISO week and gradient of cumExcess and cumDeaths.
DeathsTogetherCum2020_2021 <- DeathsTogetherCum2020_2021 %>%
  group_by(Age) %>%
...
YearColours = c("2020" = "grey50",
                "2021" = "black")
YearLineThicknesses = c("2020" = 0.5,
                        "2021" = 1.5)
